...
public class GrapplingGun : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask grapplePASSTHROUGHLayerNumber;
    ...
    {
        RaycastHit2D hit;
        if (Physics2D.Raycast(firePoint.position, Mouse_FirePoint_DistanceVector.normalized, Mathf.Infinity, ~grapplePASSTHROUGHLayerNumber))
        {
            RaycastHit2D _hit = Physics2D.Raycast(firePoint.position, Mouse_FirePoint_DistanceVector.normalized, Mathf.Infinity, ~grapplePASSTHROUGHLayerNumber);
